...
|--------------|----------|--------|
| [0001-init-project.md](specs/todo/0001-init-project.md) | Инициализация Go модуля | 3.6 KB |
| [0002-makefile.md](specs/todo/0002-makefile.md) | Система сборки | 3.3 KB |
| [0003-data-model.md](specs/todo/0003-data-model.md) | Модель данных Graph/Node/Edge | 5.3 KB |
| [0004-go-analyzer.md](specs/todo/0004-go-analyzer.md) | Анализатор Go кода | 10.5 KB |
| [0005-cli-framework.md](specs/todo/0005-cli-framework.md) | CLI фреймворк на Cobra | 4.9 KB |
| [0006-collect-command.md](specs/todo/0006-collect-command.md) | Команда сбора архитектуры | 7.3 KB |
| [0007-tracer-library.md](specs/todo/0007-tracer-library.md) | Библиотека трассировки | 11.2 KB |
| [0008-trace-command.md](specs/todo/0008-trace-command.md) | Команда генерации контекстов | 11.4 KB |
| [0009-tracerlint.md](specs/todo/0009-tracerlint.md) | Линтер для tracer вызовов | 7.5 KB |
| [0010-integration-tests.md](specs/todo/0010-integration-tests.md) | Интеграционные тесты | 8.3 KB |

### Время выполнения

- Реализация всех 10 спецификаций: ~45 минут
- Исправление ошибок компиляции: ~10 минут
